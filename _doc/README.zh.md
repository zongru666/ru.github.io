...
### [我的博客在这里 &rarr;](http://zognru666.github.io)
...
我的博客仓库——`zognru666.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`RUblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone git@github.com:RUpro/RUblog-boilerplate.git
```
...
```
# Site settings
title: RU Blog             # 你的博客网站标题
SEOTitle: RU Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: RUpro     # 你的github账号
weibo_username: RUpro      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-RU.jpg     #你的大头贴，请使用绝对地址.
```
...
我的博客标题是 **“RU Blog”** 但是我想要在搜索的时候显示 **“RU的博客 | RU Blog”** ，这个就需要SEO Title来定义了。
